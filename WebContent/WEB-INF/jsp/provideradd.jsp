...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${ctx }/provider/providersave.html">
...
<script type="text/javascript" src="${ctx}/static/js/provideradd.js"></script>
