...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="get"   action="${ctx }/bill/billsave.html">
                 		...
                 		<c:if test="${providerList != null }">
						   ...
						   <c:forEach var="provider" items="${providerList}">
						   		<option  <c:if test="${provider.id == providerId }">selected="selected"</c:if>
						   		    value="${provider.id}">${provider.proName},${provider.id}</option>
						   </c:forEach>
						</c:if>
		         </select>
...
<script type="text/javascript" src="${ctx }/static/js/billadd.js"></script>